...
class Countdown {
    ...
    public function __construct(string $format) {
        if (is_numeric($format)) {
            if (intval($format) <= 0) {
                throw new InvalidArgumentException("§c0 y valores negativos no son válidos");
            }
            ...
            switch (strtolower($formatChars[$i])) {
                case "s":
                    if ($currentCharacters == "") {
                        throw new InvalidArgumentException("§cIngresa un formato de tiempo válido");
                    }
                    if (intval($currentCharacters) <= 0) {
                        throw new InvalidArgumentException("§c0 y valores negativos no son válidos en el formato de tiempo");
                    }
                ...
                case "m":
                    if ($currentCharacters == "") {
                        throw new InvalidArgumentException("§cIngresa un formato válido de tiempo");
                    }
                    if (intval($currentCharacters) <= 0) {
                        throw new InvalidArgumentException("§c0 y valores negativos no son válidos en el formato de tiempo");
                    }
                ...
                case "w":
                    if ($currentCharacters == "") {
                        throw new InvalidArgumentException("§cIngresa un formato válido de tiempo de tiempo");
                    }
                    if (intval($currentCharacters) <= 0) {
                        throw new InvalidArgumentException("§c0 y valores negativos no son válidos en el formato de tiempo");
                    }
